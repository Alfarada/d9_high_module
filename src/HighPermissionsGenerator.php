...
use Drupal\high\Entity\HighTypeEntity;
use Drupal\Core\StringTranslation\StringTranslationTrait;

/**
 * Class HighPermissionsGenerator
 */
class HighPermissionsGenerator
{
    ...
    /**
     * Loop through all HighTypeEntity and build an array of permissions.
     *
     * @return array
     */
    public function highTypePermissions()
    {
        $perms = [];
        foreach (HighTypeEntity::loadMultiple() as $entity_type) {
     ...
     *
     * @param HighTypeEntity $entity_type
     *
     * @return array
     */
    protected function buildPermissions(HighTypeEntity $entity_type)
    {
