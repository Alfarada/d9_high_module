...
class HighTypeEntityForm extends BundleEntityFormBase {

  public function form(array $form, FormStateInterface $form_state) {
    $form = parent::form($form, $form_state);

     /** @var \Drupal\high\Entity\HighTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\high\Entity\HighTypeEntity::load',
      ],
