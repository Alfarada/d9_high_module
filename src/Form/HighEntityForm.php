...
namespace Drupal\high\Form;

use Drupal\Core\Entity\ContentEntityForm;
use Drupal\Core\Form\FormStateInterface;

/**
 * Class HighEntityForm
 */
class HighEntityForm extends ContentEntityForm
{
    // this method should be overridden to provide specific messages.
    ...
    public function save(array $form, FormStateInterface $form_state)
    {
        ...
        //  depending on the message, redirects ...
        switch ($status) {
            case SAVED_NEW:
